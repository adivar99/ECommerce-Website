...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16" onclick="window.location.replace('index.php')">
    ...
    <div id="login">
        <button class="button" id="loginbtn" style="border-color:#555555;">Log In</button>
    </div>
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    <a href="#" onclick="obj.select('Shirts')" class="w3-bar-item w3-button">Shirts</a>
    <a href="#" onclick="obj.select('Tshirts')" class="w3-bar-item w3-button w3-light-grey"><i class="fa fa-caret-right w3-margin-right"></i>T-Shirts</a>
    <a href="#" onclick="obj.select('Jeans')" class="w3-bar-item w3-button" id="myBtn">Jeans</a>
...
function init(){
    //console.log("in init");
    obj = new Products();
    obj.getItems("Tshirts")
    c=setTimeout(init,120000)
}
function Products(){
    ...
    this.select=function(category){
        st="http://localhost/Project1/"+category+".php";
